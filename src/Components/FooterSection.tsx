...
const  FooterSection =()=> {
  return (
    <div className='mt-28 w-full bg-green h-fit md:h-28  flex  md:justify-between justify-center items-center flex-wrap gap-5 py-5 px-3 sm:px-10'>
        <span className="text-white font-bold text-xl">Code by Dimidev  2024</span>
        <div className="flex justify-end items-center w-11/12 md:w-1/2 lg:w-5/12 h-10 min-w-64">
         ...
         <button className="text-white bg-black hover:bg-transparent border-2 transition-all border-black hover:text-black h-full px-3 ">S'abonner</button>
        </div>
